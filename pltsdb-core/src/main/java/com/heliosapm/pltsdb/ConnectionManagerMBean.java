 ...
 * <p><code>com.heliosapm.pltsdb.ConnectionManagerMBean</code></p>
 */

public interface ConnectionManagerMBean {
	/** The MBean's ObjectName */
	public static final ObjectName OBJECT_NAME = JMXHelper.objectName("com.heliosapm.pltsdb:service=ConnectionManager");
